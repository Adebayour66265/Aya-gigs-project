...
import loginInstructorValidation  from "../validation/loginInstructor.js";
 ...
 export const updateUserById = async (req, res) => {
    ...
    try{
      ...
      await User.findOneAndUpdate({_id:id},{firstname,lastname,email,role,password}, {useFindAndModify:false});
...
export const deleteUserById = async (req, res) => {
 ...
 export const registerInstructor = async (req, res) => {
  ...
  if (error) {
    ...
    try {
      const { lastname,firstname, email, password,phoneNumber,role,  } = req.body;
      ...
      const token = jwt.sign({ userId: savedInstructor._id }, process.env.JWT_SECRET);
